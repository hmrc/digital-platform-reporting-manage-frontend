...
class SecondaryContactPhoneNumberControllerSpec extends SpecBase with MockitoSugar {
  ...
  val formProvider = new SecondaryContactPhoneNumberFormProvider()
  ...
  "SecondaryContactPhoneNumber Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(SecondaryContactPhoneNumberPage, "answer").success.value
