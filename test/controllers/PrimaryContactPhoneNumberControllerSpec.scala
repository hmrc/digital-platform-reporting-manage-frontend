...
class PrimaryContactPhoneNumberControllerSpec extends SpecBase with MockitoSugar {
  ...
  val formProvider = new PrimaryContactPhoneNumberFormProvider()
  val form = formProvider()

  lazy val primaryContactPhoneNumberRoute = routes.PrimaryContactPhoneNumberController.onPageLoad(NormalMode).url
  ...
  "PrimaryContactPhoneNumber Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(PrimaryContactPhoneNumberPage, "answer").success.value
