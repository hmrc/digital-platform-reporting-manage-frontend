...
class CanPhoneSecondaryContactControllerSpec extends SpecBase with MockitoSugar {
  ...
  val formProvider = new CanPhoneSecondaryContactFormProvider()
  val form = formProvider()

  lazy val canPhoneSecondaryContactRoute = routes.CanPhoneSecondaryContactController.onPageLoad(NormalMode).url
  ...
  "CanPhoneSecondaryContact Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(CanPhoneSecondaryContactPage, true).success.value
